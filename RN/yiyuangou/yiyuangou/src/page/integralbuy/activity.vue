...
<template>
  <div>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <img :src="activityInfo.Supplier" width="50" height="50" class="head_pic"/>
            </template>
          </el-table-column>
          <el-table-column
            prop="requirement"
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button
                size="mini"
                type="danger"
                @click.native.prevent="deleteRow(scope.$index, activityInfo)">删除</el-button>
            </template>
          </el-table-column>
          <el-table-column
            label="评论管理">
    ...
    <el-dialog title="添加积分抢购商品" :visible.sync="addproduct" width="40%">
