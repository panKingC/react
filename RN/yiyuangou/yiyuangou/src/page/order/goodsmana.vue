  ...
  <div>
       ...
       <el-row class="main">
        ...
        <el-table-column label="操作" fixed="right" width="140" align="center">
            <template slot-scope="scope">
              <el-button  size="mini" type="primary"  @click="handleEdit(scope.row)">发货</el-button>
           </template>
        </el-table-column>                       
        </el-table>
        <el-pagination
    ...
    <el-dialog title="物流信息" :visible.sync="dialogFormVisible">
      <el-form :model="form">
       <el-form-item label="物流公司" :label-width="formLabelWidth" >
        <el-select v-model="form.logistics" placeholder="请选择物流公司">
          <el-option label="顺风快递" value="1"></el-option>
